PROPTRADER AI v18.6 — REZUMAT ACTUALIZARE
...
- GER40 este analizat complet; DE40, DAX40, GERMANY40 și simbolurile broker echivalente sunt unificate sub GER40.
- USOIL este analizat complet; WTI, XTIUSD, OIL_CRUDE și simbolurile broker echivalente sunt unificate sub USOIL.
- Istoricul GER40 și USOIL se descarcă din Dukascopy prin Germany 40 (`deuidxeur`) și US Light Crude Oil (`lightcmdusd`).
- Știrile oficiale ECB și EIA completează filtrele pentru GER40 și USOIL.
- TP1, TP2 și TP3 rămân ordonate și separate cu minimum 0,35R.
- Indicatorul PropTrader_AI_v18_6_SMC_Visual.pine desenează zona Entry, SL și TP1–TP3 direct pe graficul TradingView și blochează BUY în PREMIUM / SELL în DISCOUNT.
...
- Pentru analiză live, alerta colectorului M5 trebuie creată separat și pe graficele GER40 și USOIL.
- După deploy, /health trebuie să afișeze 18.6.0.
